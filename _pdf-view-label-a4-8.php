...
?>
	...
	<td style="width:50%;padding-bottom: 25px; padding-right: 55px; text-align: left;">
		...
		<table style="width:7cm; " cellpadding="0" cellspacing="0">
			<tr>
				<td style="text-align: center; width:60px; height: 7cm" rowspan="2">
						<?php 
				...
				<td style="border:solid 1px #CCC; height:62px; text-align: center; width:7cm; padding: 5px; font-size: 12px <?=$warna?>">
					<img src="https://upload.wikimedia.org/wikipedia/commons/a/ac/LOGO_KABUPATEN_KLATEN.png" style="height: 100%; float: left;">
					<?=$LabelData['NamaPerpustakaan']?></td>
			</tr>
			<tr>
