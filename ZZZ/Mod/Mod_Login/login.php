	...
	<div style="width: 400px; height: 400px; padding: 50px; border-radius: 0px 10px 10px 0px; background-color: #fff; float: left; font-family: arial;">
		...
		<div style="width: 400px; height: 320px;">
			<form action="proses.php" method="POST">
				...
				<a href="#" style="font-size: 12px; text-decoration: none; padding: 10px;">Lupa Password ?</a><br><br>
				<input type="submit" value="Masuk" name="" style="margin: 10px; background-color: #0000; border:1px solid #000; padding: 7.5px 20px; border-radius: 10px;">
				<br>
				<a href="index.php?url=signup" style="float: right; top: 100px; font-size: 12px; position: relative; text-decoration: none;">Regestrasi Akun Baru ~></a>
			</form>
		</div>
	</div>
</div>
